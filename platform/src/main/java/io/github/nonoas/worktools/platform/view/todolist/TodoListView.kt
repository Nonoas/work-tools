import io.github.nonoas.worktools.platform.view.todolist.TodoListVo
...
class TodoListView : javafx.scene.control.ListView<TodoListVo>() {
    ...
    private inner class TodoListCell : javafx.scene.control.ListCell<TodoListVo>() {
