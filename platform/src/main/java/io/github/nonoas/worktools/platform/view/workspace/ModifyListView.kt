package io.github.nonoas.worktools.platform.view.workspace
...
import io.github.nonoas.worktools.platform.utils.FileUtil.deleteFile
 ...
 * @date 2022/3/18
 */
open class ModifyListView : javafx.scene.control.ListView<ModifyItemVo?>() {
     ...
     * 列表单元格
     */
    protected class ModifyListCell : javafx.scene.control.ListCell<ModifyItemVo?>() {
        /**
         * 双击事件处理
         */
        ...
        private fun initContextMenu() {
            ...
            miOpenDescFile.onAction = EventHandler { event: ActionEvent? -> DesktopUtil.open(File(item!!.absolutePath + File.separator + "0-修改说明.md")) }
            ...
            miRename.onAction = EventHandler {
                ...
                val dialog: TextInputDialog = object : javafx.scene.control.TextInputDialog(item.desc) {
                    init {
                        headerText = null
                        initOwner(MainStage.Companion.instance!!.stage)
                    }
                }
